// todo 🚢 Ship challenge - a SOL transfer script
// https://buildspace.so/p/solana-core/lessons/build-an-interaction-script
...
async function transfer(
  ...
  console.log(
    ...
    } SOL to ${recipientPublicKey.toBase58()}`
  );
}
...
async function main() {
  ...
  await transfer(
    ...
    "8QmYmV7yU6FpK6f8DwzZ1V7ZL6zX9v7aJ8W1Y1Y1Y1Y1"
  );
}
